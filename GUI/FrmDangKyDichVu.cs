...
namespace GUI
{
    public partial class FrmDangKyDichVu : Form
    {
        ...
        private void FrmDangKyDichVu_Load(object sender, EventArgs e)
        {
            ...
            comboBox3.DataSource = xl.LoadPTNew();
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            ...
            //string mathutien = xl.getmathutien(dataGridView1.CurrentRow.Cells[0].Value.ToString());
            //dataGridView2.DataSource = xl.LoadDVPHIEUTHUE(mathutien);
